...
#SBATCH --job-name=bart-meta
#SBATCH --output=/gfs-ssd/user/rcardena/sci-journalism/logs/bart-large-meta.log
#SBATCH --error=/gfs-ssd/user/rcardena/sci-journalism/logs/bart-large-meta.err
...
OUTPUT_DIR="${BASEDIR}/exps/bart-large-meta/"
...
python run_summarization.py \
    ...
    --cache_dir ${CACHE_DIR} \
    --train_file ${DATASET_DIR}/valid_meta.rct_hf.json \
    --validation_file ${DATASET_DIR}/test_meta.rct_hf.json \
    --test_file ${DATASET_DIR}/test_meta.rct_hf.json
